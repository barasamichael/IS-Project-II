...
WEB_SEARCH_CONFIDENCE_THRESHOLD = 0.5

BM25_RRF_K = 60
BM25_INDEX_TOP_K = 20
CROSS_ENCODER_MODEL = "cross-encoder/ms-marco-MiniLM-L-6-v2"

INTENT_AMBIGUITY_GAP = 0.05
INTENT_FALLBACK_LLM_LOWER = 0.40
INTENT_FALLBACK_LLM_UPPER = 0.55
INTENT_FALLBACK_LLM_MODEL = "gpt-4.1-nano"

INTENT_THRESHOLDS: Dict[str, float] = {
    "housing_inquiry": INTENT_OFF_TOPIC_THRESHOLD,
    "university_info": INTENT_OFF_TOPIC_THRESHOLD,
    "immigration_visa": INTENT_OFF_TOPIC_THRESHOLD,
    "transportation": INTENT_OFF_TOPIC_THRESHOLD,
    "safety_concern": INTENT_OFF_TOPIC_THRESHOLD,
    "cost_inquiry": INTENT_OFF_TOPIC_THRESHOLD,
    "banking_finance": INTENT_OFF_TOPIC_THRESHOLD,
    "healthcare": INTENT_OFF_TOPIC_THRESHOLD,
    "cultural_adaptation": INTENT_OFF_TOPIC_THRESHOLD,
    "emergency_help": INTENT_OFF_TOPIC_THRESHOLD,
    "procedural_query": INTENT_OFF_TOPIC_THRESHOLD,
}
