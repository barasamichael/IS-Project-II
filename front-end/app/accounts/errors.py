...
def forbidden(e):
    ...
    return render_template("accounts/403.html"), 403


@accounts.app_errorhandler(404)
def page_not_found(e):
    ...
    return render_template("accounts/404.html"), 404


@accounts.app_errorhandler(500)
def internal_server_error(e):
    ...
    return render_template("accounts/500.html"), 500
