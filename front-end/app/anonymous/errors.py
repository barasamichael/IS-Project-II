...
@anonymous.app_errorhandler(403)
def forbidden(e):
    """
    ...
    return render_template("anonymous/403.html"), 403


@anonymous.app_errorhandler(404)
def page_not_found(e):
    ...
    return render_template("anonymous/404.html"), 404


@anonymous.app_errorhandler(500)
def internal_server_error(e):
    ...
    return render_template("anonymous/500.html"), 500
